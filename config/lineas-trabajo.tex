...
%
% REGLAS INSTITUCIONALES DEL ANEXO 1:
% - Las líneas II, III, IV y V se consideran para diseño de productos de:
%   consumo, biomédicos, didácticos o de investigación.
% - Todas las líneas deben contemplar las cuatro áreas de la Mecatrónica,
%   independientemente de que alguna de ellas tenga menor peso.
% - El Anexo 1 no establece una frase de característica adicional para la Línea VI.
%
