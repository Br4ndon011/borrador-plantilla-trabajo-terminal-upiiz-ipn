...
%
% Escriba ÚNICAMENTE una de las tres opciones:
\TipoDocumento{TTI}
...
% Área de ubicación (Aplica principalmente para PROTOCOLO)
\newcommand{\areaUbicacion}{Ingeniería Mecatrónica}

% Intención de titulación (Aplica principalmente para PROTOCOLO)
...
% de los alumnos no utilizados (ej. \newcommand{\alumnoBNombre}{})
