...
\begin{minipage}[c][0.96\textheight][s]{0.80\textwidth}
    ...
    \begin{minipage}{0.96\linewidth}
        \begin{tabular}{@{}p{0.52\linewidth}@{\hspace{0.03\linewidth}}p{0.45\linewidth}@{}}
            {\fontsize{10.5}{13}\bfseries\sffamily Presentan:} & {\fontsize{10.5}{13}\bfseries\sffamily Intención de Titulación:}\\[0.4em]
            {\fontsize{9.5}{12.5}\sffamily \alumnoANombre} & {\fontsize{9}{12}\sffamily $\checkmark$\,Curricular \quad Otro: \underline{\hspace{1.1cm}}}%
            \ifcsvoid{alumnoBNombre}{}{%
                \tabularnewline[0.35em]
                {\fontsize{9.5}{12.5}\sffamily \alumnoBNombre} & {\fontsize{9}{12}\sffamily $\checkmark$\,Curricular \quad Otro: \underline{\hspace{1.1cm}}}%
            }%
            \ifcsvoid{alumnoCNombre}{}{%
                \tabularnewline[0.35em]
                {\fontsize{9.5}{12.5}\sffamily \alumnoCNombre} & {\fontsize{9}{12}\sffamily $\checkmark$\,Curricular \quad Otro: \underline{\hspace{1.1cm}}}%
            }%
        \end{tabular}
    \end{minipage}\\[1.4em]
