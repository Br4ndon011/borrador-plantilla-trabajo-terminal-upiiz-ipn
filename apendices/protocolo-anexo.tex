...
\noindent En este apartado se integra el currículum vitae de los asesores del proyecto en forma resumida (no más de dos páginas por asesor), donde se indica su número de cédula profesional (licenciatura, maestría o doctorado), en estricto apego al punto 17 del Anexo 1 del Reglamento de Trabajo Terminal vigente. Asimismo, de conformidad con el punto 18 del citado anexo, la última hoja del documento corresponde al Instrumento de Evaluación del Protocolo (Anexo 2).
...
\IfFileExists{anexos/cv-asesor-1.pdf}{%
    \includepdf[pages=1-2,pagecommand={\thispagestyle{empty}}]{anexos/cv-asesor-1.pdf}%
}{%
    \begin{center}
...
\ifcsvoid{asesorBNombre}{}{%
    \IfFileExists{anexos/cv-asesor-2.pdf}{%
        \includepdf[pages=1-2,pagecommand={\thispagestyle{empty}}]{anexos/cv-asesor-2.pdf}%
    }{%
        \begin{center}
            \fbox{\parbox{0.88\textwidth}{%
                \centering\vspace{0.8em}
...
\ifcsvoid{asesorCNombre}{}{%
    \IfFileExists{anexos/cv-asesor-3.pdf}{%
        \includepdf[pages=1-2,pagecommand={\thispagestyle{empty}}]{anexos/cv-asesor-3.pdf}%
    }{%
        \begin{center}
            \fbox{\parbox{0.88\textwidth}{%
                \centering\vspace{0.8em}
...
\IfFileExists{anexos/anexo-2-evaluacion.pdf}{%
    \includepdf[pages=1,pagecommand={\thispagestyle{empty}}]{anexos/anexo-2-evaluacion.pdf}%
}{%
    \vfill
    \begin{center}
        \fbox{\parbox{0.88\textwidth}{%
