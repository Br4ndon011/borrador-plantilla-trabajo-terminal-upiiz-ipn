...
\vspace{1.5cm}
\begin{center}
    {\fontsize{11}{13}\bfseries\sffamily Conformidad de Objetivos del Proyecto}\\[0.3em]
    {\fontsize{9}{11}\sffamily Con la firma de esta sección, los alumnos y asesores avalan formalmente los objetivos aquí establecidos.}\\[1.0em]
